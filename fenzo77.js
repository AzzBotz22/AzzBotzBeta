...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "ᴿ᭄ AZZ ×፝֟͜×+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
status: 1,
surface : 1,
message: 'ᴿ᭄ AZZ ×፝֟͜×', //Kasih namalu
orderTitle: 'Bang',
...
const fakey = (teks) => {
            mans.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Join Jadi Wibu 😎`,"body": `Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/fenzo.jpg`),"sourceUrl": "https://chat.whatsapp.com/G3ydGzHeZ825IU4RjLuToY"}}}, { quoted: m})
        }
const ftextt = {
key: { 
fromMe: false,
...
Saya *${namebot}*, Assisten *ᴿ᭄ AZZ ×፝֟͜×* Bot Ini Adalah Beta Multi-Device WhatsApp.
...
❏ *Info Creator*
> Name : *ᴿ᭄ AZZ ×፝֟͜×*
> Nomor : *Wa.me/62859194145686*
> Umur : *18+*
> Region : *Indonesia 🇲🇨*
> Hobyy : *Turuu*
> Made in : *Medan*
> Nama Asli : *Tanya Emak Saya*
────────────
❏ *Info Server*
...
case 'hanzo': case 'prp': case 'inventori': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	{ urlButton: { displayText: `Group WhatsApp`, url : `https://chat.whatsapp.com/G3ydGzHeZ825IU4RjLuToY` } },
        	{ urlButton: { displayText: `Instagram`, url : `Besok Dibuat` } },
            { urlButton: { displayText: `☎️Contact Me`, url: `+62 859-1941-45686` } },
            { quickReplyButton: { displayText: `🏧 leaderboard`, id: 'leaderboard'} }
        	]
        	mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© ᴿ᭄ AZZ ×፝֟͜×', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
        	}
        	break
...
case 'list': case 'menu': case 'help': case '?': {
                let kontol = [{
                                urlButton: {
                                    ...
                                    url: 'Wa.me/62859194145686'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 859-1941-45686'
                                }
                            },{
                                quickReplyButton: {
...
mans.send5ButImg(m.chat, listmn, `© ᴿAzzBotz`, global.thumb, kontol)
}
        	break
case 'grupbot':
case 'groupbot':
case 'botgrup':
fakey(`https://chat.whatsapp.com/G3ydGzHeZ825IU4RjLuToY`)
break
case 'limit':
...
case 'quotesimage':case 'qoutesimage':
				   ...
				   fakey(mess.wait)
				  mans.sendMessage(m.chat, { image: { url: cok }, caption: 'Done By ᴿ᭄ AZZ ×፝֟͜×' }, { quoted: m })
				  break
...
jpegThumbnail: thum,
caption: teks_vote,
footer: "© ᴿ᭄ AZZ ×፝֟͜×+ - X - ᴿ᭄ AZZ ×፝֟͜×+",
buttons: buttonsVote,
headerType: 1
}
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "ᴿ᭄ AZZ ×፝֟͜×+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
mans.setStatus(`©AzzBotz || On 24 Jam || ᴿ᭄ AZZ ×፝֟͜× ||`)
}
break
case 'setstatut':
case 'setbio':
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"ᴿ᭄ AZZ ×፝֟͜×+ - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"ᴿ᭄ AZZ ×፝֟͜×+ - Facebook Downloader",
...
case 'iqra': {
	if (isLimit < 1) return reply("Limit kamu sudah habis , silahkan beli dengan cara #buy limit _jumlah_")
     ...
     m.reply(`Satu limit terpakai\nSisa limit kamu : ${global.db.users[m.sender].limit}`)
		...
		mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf By ᴿ᭄ AZZ ×፝֟͜×`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
